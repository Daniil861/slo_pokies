...
let casino1 = document.querySelector('#legends-1');
let casino2 = document.querySelector('#legends-2');
let casino3 = document.querySelector('#legends-3');
let casino4 = document.querySelector('#legends-4');
if (casino1 && casino2 && casino3 && casino4) {
	let mcasino1 = new SlotMachine(casino1, {
		active: 0,
		delay: 500
	});
	let mcasino2 = new SlotMachine(casino2, {
		active: 2,
		delay: 500
	});
	let mcasino3 = new SlotMachine(casino3, {
		active: 1,
		delay: 500
	});
	let mcasino4 = new SlotMachine(casino4, {
		active: 5,
		delay: 500
	});
...
// Второе казино
let casino5 = document.querySelector('#fallen-1');
let casino6 = document.querySelector('#fallen-2');
let casino7 = document.querySelector('#fallen-3');
let casino8 = document.querySelector('#fallen-4');
let casino9 = document.querySelector('#fallen-5');
if (casino5 && casino6 && casino7 && casino8 && casino9) {
	let mcasino5 = new SlotMachine(casino5, {
		active: 1,
		delay: 500,

	});
	let mcasino6 = new SlotMachine(casino6, {
		active: 2,
		delay: 500,

	});
	let mcasino7 = new SlotMachine(casino7, {
		active: 6,
		delay: 500,

	});
	let mcasino8 = new SlotMachine(casino8, {
		active: 0,
		delay: 500,

	});
	let mcasino9 = new SlotMachine(casino9, {
		active: 4,
		delay: 500,
...
//Auto spin
if (document.querySelector('.footer-actions__btn_bet')) {
	document.querySelector('.footer-actions__btn_bet').addEventListener('click', () => {
		if (casino1 && casino2 && casino3 && casino4) {
			gameSlotTwo();
